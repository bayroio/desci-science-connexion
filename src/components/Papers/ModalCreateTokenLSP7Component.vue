<!-- 
  /* */ 
  /* Pantalla que permite la creacion del NFT bajo al estandar LSP7 */
  /* */ 
 -->

<!-- Importamos las librerias para crear los NFT bajo el estandar LSP7 -->
<script setup>
    import { ref } from 'vue';
    ...
    async function onSubmit(e) {
        ...
        let contracts;
        try {
            //Establecenos los datos del token
